                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="for-group">
                                    ...
                                    <input type="number" step="0.01" placeholder="1000.50" class="form-control" @if(isset($user->max_transaction))value="{{$user->max_transaction}}" @else value="0" @endif min="0" id="maxTransaction" name="maxTransaction">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
...
// Obsługa pokazania/ukrycia panelu pakietu medycznego
            ...
            //THIS PART IS REQUIRED FOR LOGIN_PHONE VALIDATION. THIS CHECKS WHETHER LOGIN PHONE WAS EDITED
            var changedPbxId = false;
            var basicPbxVal = $('#login_phone').val();
            $('#login_phone').on('change', function() {
                var actualVal = $(this).val();
                if(actualVal == basicPbxVal) {
                    changedPbxId = false;
                }
                else {
                    changedPbxId = true;
