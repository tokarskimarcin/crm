  ...
  <div class="col-md-6">
      <form method="POST" action="password_change">
          ...
          <div class="form-group">
              ...
              <input name="old_pass" id="old_pass" type="password" class="form-control" />
          </div>
          <div class="form-group">
              <label for="new_pass">Podaj nowe hasło:</label>
              <input name="new_pass" id="new_pass" type="password" class="form-control" />
          </div>
          <div class="form-group">
              <label for="new_pass_confirm">Powtórz nowe hasło:</label>
              <input name="new_pass_confirm" id="new_pass_confirm" type="password" class="form-control" />
          </div>
          <div class="form-group">
