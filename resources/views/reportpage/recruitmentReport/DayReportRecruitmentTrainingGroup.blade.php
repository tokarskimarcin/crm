    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="page-header">
                <div class="alert gray-nav">Raport Dzienny Szkoleń</div>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12">
            <form action="{{URL::to('/pageDayReportRecruitmentTrainingGroup')}}" method="post">
                        ...
                        <div class="col-lg-12">
                            <div id="start_stop">
                                <div class="panel-body">
                                        @include('mail.recruitmentMail.dayReportRecruitmentTrainingGroup')
                                    </div>
                                </div>
                            </div>
                        </div>
