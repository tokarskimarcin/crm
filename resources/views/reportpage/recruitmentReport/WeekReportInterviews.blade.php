    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="page-header">
                <div class="alert gray-nav">Tygodniowy Raport Rozmów Rekrutacyjnych</div>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12">
            <form action="{{URL::to('/pageWeekReportInterviews')}}" method="post">
                        ...
                        <div class="col-lg-12">
                            <div id="start_stop">
                                <div class="panel-body">
                                        @include('mail.recruitmentMail.weekReportInterviews')
                                    </div>
                                </div>
                            </div>
                        </div>
