                                ...
                                <div id="collapseOne" class="panel-collapse collapse in">
                                    <div class="panel-body">
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group date form_date col-md-6" data-date="" data-date-format="yyyy-mm-dd" data-link-field="datak" style="width:100%;">
...
@section('script')
    ...
    <script>
        ...
        $(document).ready( function () {
            ...
            table = $('#datatable').DataTable({
                ...
                "columns":[
                    ...
                    {"data": function (data, type, dataToSet) {
                        ...
                        return "<span name='user_register_start'>"+ data.register_start + "</br><span class='fa fa-arrow-circle-o-down fa-fw'></span> </br> <span name='user_register_stop'>" + data.register_stop +"</span>";
                    },"name": "register_start"},
            ...
            /*
            * Event listener responsible for refreshing ajax request after clicking on checkbox
            */
