<table style="width:100%;border:1px solid #231f20;border-collapse:collapse;padding:3px">
    ...
    <tr>
        <td colspan="6" style="border:1px solid #231f20;text-align:center;padding:3px;background:#231f20;color:#efd88f">
            <font size="6" face="Calibri">RAPORT DZIENNY TRENERZY {{$department->departments->name . ' ' . $department->department_type->name}} DZIEN </font></td>
    ...
    <tbody>
            ...
            @foreach($coach as $item)
                @if(is_object($item))
                    ...
                    @php
                        ...
                        $day_total_janky_count += round($item->success * $item->dkj_proc);
                    @endphp
                @endif
            @endforeach
            @php
        ...
        @php
            ...
            $day_total_janky_proc = ($day_total_success > 0) ? round(($day_total_janky_count / $day_total_success), 2) : 0 ;
        @endphp
        <tr>
