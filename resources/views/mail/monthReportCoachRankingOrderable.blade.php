    ...
    <tbody>
        @foreach($departments as $item)
            @php
                ...
                $coachFromDepartment = $coachFromDepartment->sortBy('total_average');
                $lp = 1;
            ...
            @if(!$coachFromDepartment->isEmpty())
                @foreach($coachFromDepartment as $value)
                    ...
                    <tr>
                        ...
                        <td style="{{$color}};border:1px solid #231f20;text-align:center;padding:3px"><b>{{ $value->total_login_time }} h</b></td>
                    </tr>
                    @php
                        $lp++;
                    @endphp
                @endforeach
                <tr>
                    <td colspan="9" style="background-color: #464a51;border:1px solid #231f20;text-align:center;padding:3px; height: 25px"> </td>
                </tr>
            @endif
        @endforeach
    </tbody>
