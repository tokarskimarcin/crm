<table style="width:100%;border:1px solid #231f20;border-collapse:collapse;padding:3px">
    ...
    <tbody>
        ...
        @for($i = 1; $i <= 4; $i++)
            ...
            @foreach($coachData as $item)
                ...
                <tr>
                    ...
                    <td style="border:1px solid #231f20;text-align:center;padding:3px"><b>SUMA</b></td>
        ...
        <tr>
            ...
            <td style="background-color: #efef7f;border:1px solid #231f20;text-align:center;padding:3px"><b>{{ $total_call_times }}</b></td>
            <td style="background-color: #efef7f;border:1px solid #231f20;text-align:center;padding:3px"><b>{{ $total_success }}</b></td>
            <td style="background-color: #efef7f;border:1px solid #231f20;text-align:center;padding:3px"><b>{{ $total_call_success_proc }}</b></td>
