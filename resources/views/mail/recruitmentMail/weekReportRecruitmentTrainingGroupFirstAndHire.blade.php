<table style="width:100%;border:1px solid #231f20;border-collapse:collapse;padding:3px">
    ...
    <tr>
        <td colspan="2" style="border:1px solid #231f20;text-align:center;padding:3px;background:#231f20;color:#efd88f">
            <font size="6" face="Calibri">Raport Tygodniowy Zatrudnionych kandydatów / szkoleń</font></td>
    ...
    <tr>
        ...
        <th style="border:1px solid #231f20;padding:3px;background:#231f20">Procent zatrudnionych po pierwszym etapie szkolenia</th>
    </tr>
    </thead>
    <tbody>
