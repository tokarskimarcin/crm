<table style="width:100%;border:1px solid #231f20;border-collapse:collapse;padding:3px">
    ...
    <tr>
        <td colspan="3" style="border:1px solid #231f20;text-align:center;padding:3px;background:#231f20;color:#efd88f">
            <font size="6" face="Calibri">Tygodniowy Raport Zatrudnionych Kandydatów</font></td>
        <td colspan="3" style="border:1px solid #231f20;text-align:left;padding:6px;background:#231f20">
            <img src="http://teambox.pl/image/logovc.png" class="CToWUd"></td>
    </tr>
    <tr>
        <td colspan="5" style="border:1px solid #231f20;text-align:left;padding:3px;background:#231f20;color:#efd88f">Raport od {{$date_start}} do {{$date_stop}}</td>
    </tr>
    <tr>
