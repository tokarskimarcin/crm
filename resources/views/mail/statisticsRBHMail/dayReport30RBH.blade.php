...
<table style="width:100%;border:1px solid #231f20;border-collapse:collapse;padding:3px">
    ...
    <tbody>
            ...
            <tr>
                ...
                <td style="background-color: #c67979;border:1px solid #231f20;text-align:center;padding:3px">{{$item->sum('all_checked_talks') != 0 ? round($item->sum('all_checked_talks')/$item->sum('bad_talks'),2): 0}} %</td>
