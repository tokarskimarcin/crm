...
<font size="6" face="Calibri">RAPORT GODZINNY {{$date}} Gniezno</font></td>
...
<img src="http://teambox.pl/image/logovc.png" class="CToWUd"></td>
    ...
    <tbody>
      ...
      @foreach($reports as $report)
          <tr>
              <td style="font-weight: bold;border:1px solid #231f20;text-align:center;padding:3px">Gniezno</td>
