<table style="width:100%;border:1px solid #231f20;border-collapse:collapse;padding:3px">
    ...
    <tr>
        ...
        <th style="border:1px solid #231f20;padding:3px;background:#231f20">Wykonane połączenia</th>
...
@foreach($data as $department_name => $department_info)
    @php
        ...
        $janki_percent = $sum_calls > 0 ? round(100 * $sum_janki / $sum_calls,2) : 0;
    @endphp
        @foreach($department_info as $info)
            ...
            @endif
                ...
                <td style="border:1px solid #231f20;text-align:center;padding:3px;">{{$info->received_calls}}</td>
        ...
        <tr>
            ...
            <td style="text-align: center; font-size: 1.2em; font-weight: bold; background-color: #464a51; color: white;">{{$sum_calls}}</td>
...
@endforeach
    ...
    @php
        ...
        $total_janki_percent = $total_calls > 0 ? round(100 * $total_janki / $total_calls,2) : 0;
    @endphp
    ...
    <tr style="background-color: orange; font-size: 1.4em;">
        ...
        <td style="border:1px solid #231f20;text-align:center;padding:3px;"><b>{{$total_calls}}</b></td>
